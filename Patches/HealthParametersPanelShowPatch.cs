...
internal class HealthParametersShowPatch : ModulePatch
{
    ...
    {
        return AccessTools.Method(typeof(HealthParametersPanel),
            nameof(HealthParametersPanel.Show));
    }
    ...
    {
        if (___ihealthController_0 is GClass3010 or HealthControllerClass)
        {
